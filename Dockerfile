...
# install some tools
RUN apt-get install -y --no-install-recommends git build-essential curl cron libpq-dev imagemagick ghostscript wget netcat nano libfontconfig1 libxrender1 lsb-release gnupg shared-mime-info poppler-utils
