...
# install some tools
RUN apt-get install -y --no-install-recommends git build-essential curl cron libpq-dev cmake gnupg pkg-config imagemagick wget netcat nano postgresql-client
